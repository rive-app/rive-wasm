...
# echo
# OUT_DIR=build/canvas_advanced_single/bin/release ./build_wasm.sh -s release
...
# echo
# OUT_DIR=build/canvas_advanced_lite_single/bin/release ./build_wasm.sh -l -s release
